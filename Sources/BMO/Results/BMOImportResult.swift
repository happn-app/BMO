...
public struct BMOImportResult<DbType : BMODb> {
	...
	tuple). */
	public let rootObjectsAndRelationships: [(object: DbType.ObjectType, relationships: [String: BMOImportResult<DbType>]?)]
	...
	public let changes: BMOChangesDescription<DbType.ObjectIDType>?
